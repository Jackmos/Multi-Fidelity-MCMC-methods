...
numLFs = 8; %number of low fidelity datasets
...
function [objective,coupledconstraints, userdata] = loss_function_helper(x)
    ...
    %disp(x)
    [last_goodness, all_goodness] = pyrunfile("MF_BayesOpt_Couple1_AirQuality_LSTM.py", ["goodness" "all_goodness_val"], fidelity_order_labels=sensorOrder, externalInput=1);
