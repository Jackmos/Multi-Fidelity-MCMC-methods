...
#100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 15/15 [26:11<00:00, 104.79s/trial, best loss: 0.02763204597001353] 
#{'kernel_init': 'glorot_uniform', 'l2weight': 0.010006399697844389, 'lr': 0.0016286905408205983, 'nodes': 16.0, 'opt': 'Adam'}
#1/1 [==============================] - 0s 47ms/step
#Elapsed time:  1596.5783177000121

#LF Model:
#Test MSE: 0.017217374200839443
#R^2: 0.8536534445228398
#HF Model:
#Test MSE: 0.030024412864100708
#R^2: 0.7603875913574556
#1/1 [==============================] - 0s 34ms/step
#1/1 [==============================] - 0s 47ms/step
...
ULin = modelLin.predict(
    np.vstack((reaction_LF_test[:, 0], reaction_test_help)).transpose()
)
...
reaction_test_final = np.vstack(
    (reaction_LF_test[:, 0], reaction_test_help, reaction_test_help1)
).transpose()
