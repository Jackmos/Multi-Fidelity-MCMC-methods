...
def main_function():
    ...
    example = "Basic"                                   # depending on the chosen example (specifically, Discontinuous and Basic) different parameters and different inversion method will be used
    ...
    if example=="Discontinuous":
        ...
        adapt=True
        set_seed()
        algo="MH_cuqi"    # change in pCN to see preconditioned Crank-Nicholson
        BIP=BayesianInverseProblem_NN(algorithm_name=algo,forward_NN=final_model)
