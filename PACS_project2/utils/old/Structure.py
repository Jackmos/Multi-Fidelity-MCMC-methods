...
# da includere in train?
    ...
    def training(self,x,y,epoch):
        ...
        self.hist = self.model.fit(x, y, epochs=epoch, verbose = self.verbose, callbacks=[callback],batch_size=64, validation_split=0.2)   # batch_size=32, validation_split=0.2 added
