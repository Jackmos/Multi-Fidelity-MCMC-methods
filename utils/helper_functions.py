...
class Clean:
    ...
    @staticmethod
    def create_output_directory(base_dir: str, output_folder: str) -> str:
        """
        Creates the base output directory and the specified output folder within it.
        
        Args:
            base_dir (str): The base directory where the output folder will be created.
            output_folder (str): The name of the folder to be created inside the base directory.
