...
x0_test = fidelity_order[0](xhf_test) / scale
...
for i in range(n_sim):
    ...
    #plt.plot(xhf_test, y_pred0_test, label = 'HF', color = 'blue',  linewidth = 0.3)
...
x1_test = fidelity_order[1](xhf_test) / scale
...
x2_test = fidelity_order[2](xhf_test) / scale
...
for i in range(n_sim):
    ...
    #plt.plot(xhf_test, y_pred2_test, label = 'HF', color = 'blue',  linewidth = 0.3)
...
x3_test = fidelity_order[3](xhf_test) / scale
...
for i in range(n_sim):
    ...
    #plt.plot(xhf_test, y_pred3_test, label = 'HF', color = 'blue',  linewidth = 0.3)
