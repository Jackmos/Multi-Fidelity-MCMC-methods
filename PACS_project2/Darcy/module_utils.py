...
def getModel(params,num_inputs,name, num_outputs):
    if(name == '2step'):
        ...
        hidden3 = Dense(64,activation=custom_activation,kernel_initializer=params['kernel_init'],kernel_regularizer=l2(0.001))(fourier_layer1)
        ...
        output = Dense(num_outputs,activation='linear',name='LF')(hidden5)
    elif (name == 'HF'):
        # inputs = Input(shape=(num_inputs,))
        # hidden1 = Dense(64,activation=custom_activation,kernel_initializer=params['kernel_init'],kernel_regularizer=l2(0.001))(inputs)
